...
class HtmlRenderer {
    ...
    renderContact(contact) {
        ...
        contactDetailsLink.innerHTML = `${contact.firstName} ${contact.lastName}`;

        res.querySelector(".name-value").innerHTML = contact.firstName;
    ...
    clearForm() {
        this.formDom.elements.firstName.value = null;
    ...
    toEditForm(event) {
        ...
        this.formDom.elements.firstName.value = contact.firstName;
